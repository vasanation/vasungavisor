...
\documentclass[a6paper,11pt,makeidx,openany]{book}
\usepackage[a6paper,margin=0.5in]{geometry}
\usepackage[T1]{fontenc}
\usepackage{lmodern} % Vektorfonter istället för bitmaps, för bättre resolution på texten
\usepackage[utf8]{inputenc} % UTF8 stöd så att jag kan skriva åäö
\usepackage[swedish]{babel}
\usepackage{fancyhdr}
\usepackage[pdftex]{graphicx}	% Bilder. Stöder .png, .jpg och .pdf
\usepackage{import}		
\usepackage{setspace}
\usepackage[lyric]{songs}
\usepackage{graphicx,eso-pic} % Möjliggör lite mer avancerat trixande med bilder, se kapitelbildslösningen nedan
...
% Lösning som placerar kapitelbilderna centrerat på bakgrunden, så att de inte trycker ner texten och skapar tomma sidor
